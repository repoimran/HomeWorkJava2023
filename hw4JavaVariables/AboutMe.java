...
public class AboutMe {
	...
	public void aboutMe() { // method is implemented in here
		System.out.println("hi, my name is " + name + " my age is " + age + ", im  " + height +" feet long, " + "my vision is " 
							+ vision + ", i am " + married + ", i have " + children + " daughter" + " and her age is " + childAge 
