...
public class ComputerTest {
	...
	public static void main(String[] args) {
		...
		Computer myComp2 = new Computer("Apple", "MacBook Air", "MacOS Mojave", 800, 'A', false); // with parameterized
																									// constructor 01
		Computer myComp3 = new Computer("Dell", "LSN9855", "Windows 11 pro", 300, true, 'C'); // with parameterized
																								// constructor 02
	}
}
